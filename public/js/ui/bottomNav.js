...
export function renderBottomNav() {
  ...
  // Adicionar listener para Search (abre modal ou vai para página)
  const searchBtn = nav.querySelector('[data-nav="search"]');
  if (searchBtn) {
    searchBtn.addEventListener('click', (e) => {
      // Por agora, vai para movies.html e foca na search
      // Podes mudar para abrir um modal de search depois
    });
  }
}
