        ...
        <div>
          ...
          <div class="mt-4 flex items-center gap-3 flex-wrap">
            ...
            <a href="${netflixProvider.netflixUrl}" target="_blank" rel="noopener noreferrer"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111 30" class="w-7 h-7" fill="#E50914" preserveAspectRatio="xMidYMid meet">
                <path d="M105.062 14.28L111 30c-1.75-.25-3.499-.563-5.28-.845l-3.345-8.686-3.437 7.969c-1.687-.282-3.344-.376-5.031-.595l6.031-13.75L94.468 0h5.28l3.062 7.875L105.875 0h5.28l-5.093 14.28zm-9.375 8.686l-3.062-6.937c-1.5.375-3.156.594-4.75.844L88.5 22.966zm-3.844-8.937l-2.625-6.5c-1.594.219-3.156.531-4.687.75L82.97 14.28zM64.03 0c-1.625 0-3.031.969-3.031 2.343 0 1.219.969 1.875 2.531 2.219l2.25.531c2.281.531 3.781 1.219 3.781 2.844 0 1.782-1.687 2.875-4.062 2.875-2.156 0-3.593-.75-4.688-1.219L58.28 14.28c1.219.5 2.844.969 4.844.969 2.5 0 4.156-.781 5.375-1.562 1.156-.75 1.75-1.844 1.75-3.156 0-1.219-.625-2.125-2.125-2.531l-2.218-.531c-2.031-.5-3.781-1.125-3.781-2.625 0-1.562 1.375-2.625 3.625-2.625 1.844 0 3.156.469 4.188.938L70.5 3.28C69.406 2.75 67.78 2.28 65.78 2.28zm-11.562 5.031c-1.219-.75-2.5-1.156-4.25-1.156-3.531 0-6.219 2.688-6.219 6.219 0 3.469 2.688 6.156 6.219 6.156 1.75 0 3.031-.406 4.25-1.156v4.5c-1.438.406-2.875.625-4.25.625-5.75 0-10.219-4.469-10.219-10.219 0-5.75 4.469-10.219 10.219-10.219 1.375 0 2.812.219 4.25.625v4.5zm-8.468-4.5c-1.375 0-2.5 1.125-2.5 2.5 0 1.406 1.125 2.5 2.5 2.5 1.406 0 2.5-1.094 2.5-2.5 0-1.375-1.094-2.5-2.5-2.5zm17.031 0c-1.375 0-2.5 1.125-2.5 2.5 0 1.406 1.125 2.5 2.5 2.5 1.406 0 2.5-1.094 2.5-2.5 0-1.375-1.094-2.5-2.5-2.5z"/>
              </svg>
            </a>
            ` : ""}
            ${movie.rating
